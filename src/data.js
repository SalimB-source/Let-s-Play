...
export const videos = [
  { title: 'Assassin’s Creed Black Flag Resynced', category: 'REVIEW', duration: '9:40', image: youTubeThumbUrl('0e5yXxfchLA', 'hq'), href: 'https://www.youtube.com/watch?v=0e5yXxfchLA', tag: 'Gaming', desc: 'Deep dive into Black Flag Resynced — what’s new, what’s worth it, and our verdict for 2026.' },
  { title: 'Games & Comic Con Dzair 2026', category: 'EVENT', duration: '15:17', image: youTubeThumbUrl('HzigJZOxz2o', 'hq'), href: 'https://www.youtube.com/watch?v=HzigJZOxz2o', tag: 'Culture', desc: 'Inside the biggest pop culture event in Algeria — cosplay, guests, and community.' },
  { title: 'Inside ASUS Experts Day 2025', category: 'TECH', duration: '4:26', image: youTubeThumbUrl('Zl6crcrPnPQ', 'hq'), href: 'https://www.youtube.com/watch?v=Zl6crcrPnPQ', tag: 'Tech', desc: 'Tech trends, creator gear and what ASUS is building for gamers.' },
  { title: 'Let’s Play Awards 2025: Our Pick', category: 'POP CULTURE', duration: '27:14', image: youTubeThumbUrl('0ThNyFItASM', 'hq'), href: 'https://www.youtube.com/watch?v=0ThNyFItASM', tag: 'Culture', desc: 'Our top picks for 2025 — games, movies, and moments that defined the year.' },
  { title: 'E-Sport Dzair Cup Finals', category: 'E-SPORT', duration: '22:10', image: youTubeThumbUrl('0e5yXxfchLA', 'hq'), href: 'https://www.youtube.com/watch?v=0e5yXxfchLA', tag: 'Gaming', desc: 'The finals that shook Algiers — highlights and interviews.' },
  { title: 'Cinema: Dune Messiah Preview', category: 'CINEMA', duration: '12:05', image: youTubeThumbUrl('Zl6crcrPnPQ', 'hq'), href: 'https://www.youtube.com/watch?v=Zl6crcrPnPQ', tag: 'Culture', desc: 'What to expect from the next Dune chapter.' },
];
