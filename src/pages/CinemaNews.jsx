...
export default function CinemaNews() {
  ...
  const articles = useMemo(() => [
    ...
    { to: '/news/cinema/last-of-us-saison-3', image: 'last-of-us-mod-news.jpg', alt: 'The Last of Us — série HBO', badge: 'THE LAST OF US · HBO', kicker: '22.09.2026 · HBO', title: 'THE LAST OF US SAISON 3 CONFIRMÉE.', excerpt: 'HBO a officiellement commandé une troisième saison de The Last of Us, qui adaptera la seconde partie du deuxième jeu avec de nouveaux arcs narratifs.', read: copy.read, sentiment: 'positive' },
