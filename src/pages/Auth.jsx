...
export default function Auth({ initialMode = 'signup' }) {
  ...
  return <section className="auth-page wrap">
    <div className="auth-panel">
      ...
      <div className="auth-socials"><button type="button" className="button button-ghost" onClick={() => oauth('google')} disabled={busy}>{t.google}</button><button type="button" className="button button-ghost" onClick={() => oauth('azure')} disabled={busy}>{t.microsoft}</button></div>
