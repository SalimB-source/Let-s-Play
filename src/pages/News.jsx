...
export default function News(){
  ...
  const articles = [
    { to: '/news/starcraft-fps', image: 'physint-news.jpg', alt: 'Un soldat dans un univers de science-fiction', badge: 'STARCRAFT · FPS', kicker: '12.09.2026 · BLIZZARD', title: 'STARCRAFT PASSE AU FPS.', excerpt: 'Blizzard officialise un shooter en monde ouvert situé au ras du champ de bataille. Le projet ne sortira pas avant 2030.', read: 'LIRE L’ARTICLE' },
    { to: '/news/diablo-v', image: 'onimusha-million-news.jpg', alt: 'Illustration sombre d’un jeu d’action', badge: 'DIABLO V · BLIZZCON', kicker: '12.09.2026 · BLIZZARD', title: 'DIABLO V SE PRÉPARE.', excerpt: 'Le prochain épisode arrivera au printemps 2029 dans un Sanctuaire en ruines, privé de ses héros.', read: 'LIRE L’ARTICLE' },
    { to: '/news/diablo-switch-2', image: 'zelda-40th-switch2.jpg', alt: 'Console Nintendo Switch 2', badge: 'DIABLO IV · SWITCH 2', kicker: '12.09.2026 · BLIZZARD', title: 'LE SANCTUAIRE ARRIVE SUR SWITCH 2.', excerpt: 'La collection Age of Hatred réunira le jeu de base et ses deux extensions majeures dès le 15 septembre 2026.', read: 'LIRE L’ARTICLE' },
    { to: '/news/diablo-netflix', image: 'wardogs-news.jpg', alt: 'Personnage dans un univers fantastique', badge: 'DIABLO · NETFLIX', kicker: '12.09.2026 · BLIZZARD', title: 'DIABLO ÉTEND SON UNIVERS.', excerpt: 'Une série animée Diablo est en préparation pour Netflix. Blizzard étudie aussi d’autres adaptations.', read: 'LIRE L’ARTICLE' },
