  ...
  return (
    <>
      <section className="page-hero wrap">
        ...
        <div className="page-hero-grid">
          <div>
            ...
            <div className="page-hero-actions"><a className="button button-ghost" href="#7ouma-arena-show">{page.jump} <span aria-hidden="true">↓</span></a></div>
          </div>
      ...
      <section className="partners-detail wrap">
        <div className="section-label"><span><b>03</b> / {page.details}</span><span>{page.meta}</span></div>
      ...
      <section className="partners-sources wrap">
        <div className="section-label"><span><b>04</b> / {page.sources}</span><span>{page.sourcesMeta}</span></div>
