...
export default function ZeldaOcarina(){
  ...
  return <>
    ...
    <section className="zelda-gallery wrap"><div className="section-label"><span><b>{a.visualsLabel}</b> / {a.galleryLabel}</span><span>{a.galleryMeta}</span></div><div className="zelda-gallery-grid"><figure><img src={`${base}zelda-ocarina-cover.jpg`} alt={a.galleryAlt1} /><figcaption>{a.galleryCaption1}</figcaption></figure><figure><img src={`${base}zelda-40th-anniversary.jpg`} alt={a.galleryAlt2} /><figcaption>{a.galleryCaption2}</figcaption></figure></div></section>
    <section className="article-video wrap"><div className="section-label"><span><b>{a.videoSection}</b> / {a.videoLabel}</span><span>{a.videoMeta}</span></div><div className="article-video-frame"><iframe src="https://www.youtube.com/embed/Ze-346WTsI0" title={a.videoLabel} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen /></div></section>
