...
export default function MetroidRavenous(){
  ...
  return <>
    ...
    <section className="article-video wrap"><div className="section-label"><span><b>{a.videoSection}</b> / {a.videoLabel}</span><span>{a.videoMeta}</span></div><div className="article-video-frame"><iframe src="https://www.youtube.com/embed/ku-vSTDNsT8" title={a.videoLabel} allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen /></div></section>
