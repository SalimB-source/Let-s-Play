// Ludothèque locale de l'émulateur NES : ROMs, états sauvegardés et SRAM des
...
export async function putRom({ id, name, data, builtin = false }) {
...
export async function putState(id, state, thumbnail) {
...
export async function putSram(id, bytes) {
